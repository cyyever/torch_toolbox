...
class SEBasicBlock(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.bn1 = nn.GroupNorm(num_channels=planes, num_groups=8)
        self.relu = nn.ReLU(inplace=True)
        self.conv2 = conv3x3(planes, planes, 1)
        self.bn2 = nn.GroupNorm(num_channels=planes, num_groups=8)
...
class SEBottleneck(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.bn3 = nn.GroupNorm(num_channels=planes * 4, num_groups=8)
        self.relu = nn.ReLU(inplace=True)
...
class CifarSEResNet(nn.Module):
    def __init__(self, block, n_size, num_classes=10, reduction=16):
        ...
        self.bn1 = nn.GroupNorm(num_channels=self.inplane, num_groups=8)
        self.relu = nn.ReLU(inplace=True)
...
def se_resnet20_group_norm(**kwargs):
    """Constructs a ResNet-18 model."""
